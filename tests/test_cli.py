...
def test_list_shows_score(tmp_path, capsys):
    ...
    from agent_skill_manager import cli
    _make_skill(tmp_path, "my-skill")

    with patch("agent_skill_manager.core.CENTRAL_DIR", tmp_path), \
         patch("agent_skill_manager.cli.CENTRAL_DIR", tmp_path):
        cli._print_list()
...
def test_status_shows_score_column(tmp_path, capsys):
    ...
    with patch("agent_skill_manager.core.CENTRAL_DIR", central), \
         patch("agent_skill_manager.cli.CENTRAL_DIR", central), \
         patch("agent_skill_manager.core.PRODUCTS", [product]), \
         patch("agent_skill_manager.cli.PRODUCTS", [product]), \
