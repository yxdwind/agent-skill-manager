...
FOOTER = "Generated by agent-skill-manager | github.com/yxdwind/agent-skill-manager"
...
def _print_audit_report(report: SkillReport, brief: bool = False) -> None:
    ...
    if not brief:
        print()
        print(f"  --  Generated by agent-skill-manager | github.com/yxdwind/agent-skill-manager")
